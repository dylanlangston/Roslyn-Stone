...
public class DocumentationResource
{
    ...
    )
    {
        ...
        var doc = documentationService.GetDocumentation(symbolName, packageId);

        if (doc == null)
        {
            var exampleMessage =
                packageId != null
                    ? $"Documentation not found for symbol: {symbolName} in package: {packageId}. Make sure the package is installed and contains XML documentation."
